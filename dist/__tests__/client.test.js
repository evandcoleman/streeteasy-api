...
describe('StreetEasyClient', () => {
    ...
    describe('request', () => {
        ...
        it('should make successful request', async () => {
            ...
            client = new index_1.StreetEasyClient();
            const response = await client.request(queries_1.SEARCH_RENTALS_QUERY, { filters: {} });
            expect(response).toEqual(mockResponse);
            expect(mockClient.request).toHaveBeenCalledWith(queries_1.SEARCH_RENTALS_QUERY, { filters: {} });
        });
        it('should handle Error objects', async () => {
            ...
            graphql_request_1.GraphQLClient.mockImplementation(() => mockClient);
            client = new index_1.StreetEasyClient();
            await expect(client.request(queries_1.SEARCH_RENTALS_QUERY, { filters: {} }))
                .rejects
    ...
    describe('searchRentals', () => {
        ...
        it('should make rental search request', async () => {
            ...
            expect(mockClient.request).toHaveBeenCalledWith(queries_1.SEARCH_RENTALS_QUERY, { input: params });
        });
