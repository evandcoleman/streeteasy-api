...
describe('StreetEasyClient', () => {
  ...
  describe('constructor', () => {
    it('should create client with default endpoint', () => {
      ...
      expect(GraphQLClient).toHaveBeenCalledWith('https://api-v6.streeteasy.com/', expect.any(Object));
    });
    ...
    it('should create client with custom endpoint', () => {
      ...
      expect(GraphQLClient).toHaveBeenCalledWith(customEndpoint, expect.any(Object));
    });
  ...
  describe('request', () => {
    ...
    it('should make successful request', async () => {
      ...
      client = new StreetEasyClient();
      const response = await client.request(SEARCH_RENTALS_QUERY, { filters: {} });
    ...
    it('should handle Error objects', async () => {
      ...
      client = new StreetEasyClient();
      await expect(client.request(SEARCH_RENTALS_QUERY, { filters: {} }))
        .rejects
        .toThrow('StreetEasy GraphQL Error: API Error');
    });
    ...
    it('should handle string errors', async () => {
      ...
      client = new StreetEasyClient();
      await expect(client.request(SEARCH_RENTALS_QUERY))
        .rejects
        .toThrow('StreetEasy GraphQL Error: String error message');
    });
    ...
    it('should handle null/undefined errors', async () => {
      ...
      await expect(client.request(SEARCH_RENTALS_QUERY))
        .rejects
        .toThrow('StreetEasy GraphQL Error: null');
    });
    ...
    it('should handle ClientError with validation errors', async () => {
      ...
      client = new StreetEasyClient();
      await expect(client.request(SEARCH_RENTALS_QUERY, { input: { /* invalid data */ } }))
        .rejects
        .toThrow("StreetEasy GraphQL Error: invalid type for variable: 'input'");
    });
  });
  ...
  describe('searchRentals', () => {
    ...
    it('should handle search errors', async () => {
      ...
      await expect(client.searchRentals(params))
        .rejects
        .toThrow('StreetEasy GraphQL Error: API Error');
    });
  });
